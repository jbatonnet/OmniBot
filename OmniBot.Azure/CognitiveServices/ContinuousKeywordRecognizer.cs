...
public class ContinuousKeywordRecognizer : IContinuousKeywordDetector, IDisposable
{
    public event KeywordDetectedEventHandler OnKeywordDetected;

    public bool Detecting { get; set; } = true;

    private readonly ILogger<ContinuousKeywordRecognizer> _logger;
    ...
    public ContinuousKeywordRecognizer(IAudioSource audioSource, string modelPath) : this(null, audioSource, modelPath) { }
    public ContinuousKeywordRecognizer(ILogger<ContinuousKeywordRecognizer> logger, IAudioSource audioSource, string modelPath)
    {
        _logger = logger;
